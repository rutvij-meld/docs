...
This data comes from Salt Edge Partners' [api/partners/v1/accounts](https://docs.saltedge.com/partners/v1/#accounts-attributes) endpoint and is returned from Meld's [/bank-linking/accounts](https://docs.meld.io/reference/bank-linking-accounts-search) endpoint.
