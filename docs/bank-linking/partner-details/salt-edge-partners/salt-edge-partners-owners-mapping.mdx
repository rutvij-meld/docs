...
This data comes from Salt Edge Partners' [api/partners/v1/holder_info](https://docs.saltedge.com/partners/v1/#holder_info-show) endpoint and is returned from Meld's [/bank-linking/accounts](https://docs.meld.io/reference/bank-linking-accounts-search) endpoint.
