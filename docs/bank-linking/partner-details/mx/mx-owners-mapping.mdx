...
This data comes from MX's [/users/`{user_guid}` /members/`{member_guid}` /account_owners](https://docs.mx.com/api#identification_identity_list_account_owners) endpoint and is returned from Meld's [/bank-linking/accounts](https://docs.meld.io/reference/bank-linking-accounts-search) endpoint.
