---
title: "Salt Edge Owners Mapping"
---

This data comes from Salt Edge's [/api/v5/holder_info](https://docs.saltedge.com/account_information/v5/#holder_info-show) endpoint and is returned from Meld's [/bank-linking/accounts](/api-reference/bank-linking/accounts/bank-linking-accounts-search) endpoint.
...
<Warning>
  Salt Edge does not indicate whether an address, email, or phone number is the owner's primary record. Meld defaults `addresses.primary`, `emails.primary`, and `phoneNumbers.primary` to `UNKNOWN`.
</Warning>
