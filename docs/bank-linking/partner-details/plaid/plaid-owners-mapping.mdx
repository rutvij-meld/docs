...
This data comes From Plaid's [/identity/get](https://plaid.com/docs/api/products/identity/#identity-get-response-accounts-owners-addresses-data-street) endpoint and is returned from Meld's [/bank-linking/accounts](https://docs.meld.io/reference/bank-linking-accounts-search) endpoint.
