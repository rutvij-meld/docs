...
This page outlines the steps to load the Meld bank linking widget inside your iOS mobile app using a WebView.
...
* An iOS project in Xcode
* Access to your website’s server to host the required files
