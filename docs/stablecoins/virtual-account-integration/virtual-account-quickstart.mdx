...
* **Endpoint:** [Create SubAccount](https://docs.meld.io/reference/accounts-sub-accounts-create)
* **Method:** `POST`
...
* **Endpoint:** [Get Crypto Quote](https://docs.meld.io/reference/crypto-virtual-account-quote-get)
* **Method:** `GET`
* **Authorization:** `BASIC [your-api-key]`

### Testing Options:

* **Use the interactive docs** at the [endpoint URL](https://docs.meld.io/reference/crypto-virtual-account-quote-get)
* **Use Meld's Postman collection:** [https://www.postman.com/meldeng/workspace/meld-io-public-api-collection](https://www.postman.com/meldeng/workspace/meld-io-public-api-collection)
...
* **Endpoint:** [Create Buy Order](https://docs.meld.io/reference/payments-virtual-account-ramp-onramp-order-create)
* **Method:** `POST`
* **Authorization:** `BASIC [your-api-key]`
...
* **Endpoint:** [Create Sell Order](https://docs.meld.io/reference/payments-virtual-account-ramp-offramp-order-create)
* **Method:** `POST`
* **Authorization:** `BASIC [your-api-key]`
...
Call the [search transactions endpoint](https://docs.meld.io/reference/payments-transactions-search) using the `orderId` from the previous step to view your transaction details.
...
➡️ **[Build Custom UI Guide](https://docs.meld.io/docs/virtual-account-guide)** - Complete implementation guide

## Next Steps

If you're ready to begin your integration, check out the end to end integration guide for the [Virtual Account flow](https://docs.meld.io/docs/virtual-account-guide).
