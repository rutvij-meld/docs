...
If you executed every step correctly, then when you open either the `widgetUrl` or `serviceProviderWidgetUrl`, the user goes straight to the Mercuryo payment screen, as seen in this demo video:
